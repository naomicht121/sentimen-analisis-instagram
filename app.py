...
def index():
    ...
    if request.method == 'POST':
        ...
        # 
        if username == 'yolokorea000' and password == 'yolo123':
...
def sukses_req():
    nilai = "sukses Login"
    return render_template("sukses.html", value=nilai)
    
# complete these 2 fields ==================
# ganti dan isi username dan password instagram si bawah ini
USERNAME = 'yolokorea000'
PASSWORD = 'yolo123'
# ==========================================

#masukkan username yang ingin anda cari
usr = input('Put the username for scrapping followers from: ')

#input berapa follower yang ingin anda lihat, missal: 100 pengikut 
user_input = input(
